    ...
    public String addUser(UserRegistrationRequest userRegistrationRequest) {
        ...
        try {
            ...
            if (responseEntity.getStatusCode() == HttpStatus.CREATED
                ...
                userInfo.setName(userInfo.getName() + "|" + externalId); // Marking the name field with the external ID
                userInfo.setId(externalId); // Attempt to use the external ID as the primary key. If the field is
                                            // autogenerated, this will be ignored.
